...
Route::middleware(['auth', 'active'])->group(function () {
    ...
    // Rule Allocations (Historical Integrity)
    Route::get('/attendance/rule-allocations', [App\Http\Controllers\RuleAllocationController::class, 'index'])->name('attendance.rule-allocations.index');
    Route::post('/attendance/rule-allocations', [App\Http\Controllers\RuleAllocationController::class, 'store'])->name('attendance.rule-allocations.store');

    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="d-flex flex-wrap justify-content-start mb-3">
                <a type="button" href="{{ route('tambahpegawai') }}"
                    class="btn btn-outline-info mb-2 col-12 col-md-3 col-lg-2 mr-1">
            ...
            <table id="example" class="table table-striped table-responsive display" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        {{-- <td>{{ $peg->id }}</td> --}}
                        <td>
                            <a href="pegawai/{{$peg->id }}/edit" class="btn btn-outline-info btn-sm"><i

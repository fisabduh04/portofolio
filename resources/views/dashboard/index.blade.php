    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
            ...
            <div
                ...
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span
                        class="p-2 text-purple-600 bg-purple-100 rounded-lg dark:bg-purple-900/30 dark:text-purple-300">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div
                ...
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span
                        class="p-2 text-orange-600 bg-orange-100 rounded-lg dark:bg-orange-900/30 dark:text-orange-300">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div
                class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-xl font-bold leading-none text-gray-900 dark:text-white">Tren Kehadiran (7 Hari)
                    </h3>
                </div>
            ...
            <div
                class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-xl font-bold leading-none text-gray-900 dark:text-white">Komposisi Presensi Hari Ini
                    </h3>
                </div>
        ...
        {{-- HEADLINE KEPEGAWAIAN --}}
        <div class="mb-4">
            <h2 class="text-xl font-bold text-gray-900 dark:text-white">Statistik Kepegawaian</h2>
            <p class="text-sm text-gray-500">Monitor kehadiran guru dan staf.</p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
            ...
            <div
                ...
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span
                        class="p-2 text-indigo-600 bg-indigo-100 rounded-lg dark:bg-indigo-900/30 dark:text-indigo-300">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div
                class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Terlambat</h3>
            ...
            <div
                ...
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span
                        class="p-2 text-yellow-600 bg-yellow-100 rounded-lg dark:bg-yellow-900/30 dark:text-yellow-300">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        {{-- PEGAWAI CHARTS & LISTS --}}
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
            {{-- Chart Tren Pegawai --}}
            <div
                class="lg:col-span-2 p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-xl font-bold leading-none text-gray-900 dark:text-white">Tren Kehadiran Guru (7
                        Hari)</h3>
                </div>
        ...
        <div class="grid grid-cols-1 mt-4">
            <div
                class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Early Birds (Datang Paling Awal) 🏆
                </h3>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                        @foreach ($earlyBirds as $early)
                            <div
                                ...
                                <span
                                    class="flex-shrink-0 w-8 h-8 rounded-full bg-green-100 text-green-600 flex items-center justify-center text-xs">
                                    {{ $loop->iteration }}
                                </span>
                                <div class="ml-3">
                                    <span class="block text-sm">{{ $early->pegawai->name }}</span>
                                    <span
                                        class="block text-xs text-gray-500 dark:text-gray-300">{{ $early->jam_masuk }}</span>
                                </div>
                            </div>
                        @endforeach
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (document.getElementById("today-composition-chart") && typeof ApexCharts !== 'undefined') {
                const chart = new ApexCharts(document.getElementById("today-composition-chart"),
                compositionOptions);
                chart.render();
            }
        });

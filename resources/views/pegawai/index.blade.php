                        ...
                        @forelse ($pegawai as $index => $peg)
                            <tr class="bg-neutral-primary border-b border-default last:border-0 hover:bg-neutral-secondary-soft/50 transition-colors duration-200">
                                ...
                                <th scope="row" class="px-6 py-4 flex items-center whitespace-nowrap">
                                    ...
                                    @endif
                                    <div class="pl-3">
                                        <a href="{{ route('pegawai.show', $peg->id) }}" class="text-base font-semibold text-heading hover:text-blue-600 transition-colors">{{ $peg->name }}</a>
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        <a href="{{ route('pegawai.show', $peg->id) }}" class="p-2 text-gray-600 bg-gray-50 rounded-base hover:bg-gray-100 dark:bg-gray-700 dark:text-gray-400 dark:hover:bg-gray-600 transition-colors" title="Lihat Profil">

        ...
        <table class="table table-hover tabel-striped">
            <thead>
                <tr>
                    ...
                    <th class="col-1" wire:click="sortBy('id')">
                        ID
                        @if($sortField === 'id')
                        @if($sortAsc)
                    ...
                    <th class="col-4 col-md-2" wire:click="sortBy('kelas')">
                        Kelas
                        @if($sortField === 'kelas')
                        @if($sortAsc)
                        <i class="fas fa-sort-up"></i>
                    ...
                    <th class="col-4 col-md-4" wire:click="sortBy('jurusan')">
                        Jurusan
                    ...
                    <th class="col-4 col-md-2" wire:click="sortBy('ket')">
                        Keterangan
                        @if($sortField === 'ket')
                        @if($sortAsc)
                        <i class="fas fa-sort-up"></i>

<x-layout.layout>
    ...
    <form action="{{ isset($pegawai->id) ? route('pegawai.update', $pegawai->id) : route('pegawai.store') }}" 
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div class="lg:hidden fixed bottom-14 left-0 w-full bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 p-4 shadow-lg z-50 flex gap-2">

<div>
    ...
    @props(['disabled' => false, 'label' => false, 'icon' => false])
    ...
    <div class="relative">
        ...
        <input {{ $attributes }} 
            ...
            class="{{ $type === 'file' 
                ...
                : 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ' . ($hasIcon ? 'pl-10 ' : '') . ($type === 'password' ? 'pr-10 ' : '') 
            }} @error($name) bg-red-50 border border-red-500 text-red-900 placeholder-red-700 text-sm rounded-xl focus:ring-red-500 dark:bg-gray-700 focus:border-red-500 block w-full p-2.5 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500 @enderror"

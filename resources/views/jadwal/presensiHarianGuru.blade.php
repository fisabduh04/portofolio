    ...
    <div class="mt-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
            ...
            <div class="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                ...
                @if(auth()->user()->cannot('is-guru') || (isset($isPiket) && $isPiket))
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 border-b border-gray-200 dark:border-gray-700">
                            <tr>
                                ...
                                @if(auth()->user()->cannot('is-guru') || (isset($isPiket) && $isPiket && $viewMode == 'all'))
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            @php
                                $isMySchedule = auth()->user()->pegawai_id == $jadwal->pegawai_id && auth()->user()->can('is-guru');

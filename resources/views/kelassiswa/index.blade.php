                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <!-- Delete button -->
                                        <form action="{{ route('siswa_kelas.destroy', $pemetaan->id) }}" method="POST"
                                            id="delete-form-{{ $pemetaan->id }}" style="display:inline;">
                                            @csrf
                                            @method('DELETE')

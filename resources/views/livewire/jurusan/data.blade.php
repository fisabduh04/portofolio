                    ...
                    <tr class="bg-white dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-2 py-3">
                            <button type="button" wire:click="del({{ $k->id }})"
                                ...
                                class="px-2.5 py-2 text-xs font-medium text-center inline-flex items-center justify-center text-red-700 hover:text-white rounded-lg hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 group">
                                <svg class="w-4 h-4 text-red-700 group-hover:text-white hover:text-white dark:text-white"

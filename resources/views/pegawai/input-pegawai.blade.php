<x-layout.layout>
    ...
    <form action="{{ isset($pegawai->id) ? route('pegawai.update', $pegawai->id) : route('pegawai.store') }}"
        method="POST" enctype="multipart/form-data" class="mt-6" id="pegawaiForm">
        @csrf
        @if (isset($pegawai->id))
            @method('PUT')
        @endif
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div class="lg:col-span-1 space-y-6">
                <div
                    class="p-6 bg-white border border-gray-200 rounded-base shadow-sm dark:bg-gray-800 dark:border-gray-700 sticky top-24">
                    <h3 class="mb-4 text-lg font-semibold text-gray-900 dark:text-white text-center">Foto Pegawai</h3>

                    <div class="flex flex-col items-center justify-center">
                        <div
                            class="relative w-32 h-32 sm:w-40 sm:h-40 mb-4 overflow-hidden rounded-full border-4 border-gray-100 dark:border-gray-700 shadow-sm group">
                        ...
                        <input type="file" name="foto" id="foto-upload" class="hidden" accept="image/*"
                    ...
                    <div class="hidden lg:block mt-8 space-y-2">
                        <button type="submit"
                            class="w-full flex justify-center items-center gap-2 px-5 py-3 text-sm font-medium text-white bg-blue-700 rounded-base hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 shadow-lg">
                        ...
                        <a href="{{ route('pegawai.index') }}"
                            class="w-full flex justify-center items-center px-5 py-2.5 text-sm font-medium text-gray-900 bg-white rounded-base border border-gray-200 hover:bg-gray-100">
                            Batal
                        </a>
                    </div>
                </div>
            ...
            <div class="lg:col-span-3">
                    ...
                    <ul class="flex flex-nowrap -mb-px text-sm font-medium text-center" id="pegawaiTab" role="tablist">
                        <li class="mr-2" role="presentation">
                            <button
                                ...
                                id="profil-tab" data-tabs-target="#profil" type="button" role="tab"
                                aria-controls="profil" aria-selected="false">Profil Pegawai</button>
                        </li>
                        <li class="mr-2" role="presentation">
                            <button
                                class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300"
                                id="kepegawaian-tab" data-tabs-target="#kepegawaian" type="button" role="tab"
                                aria-controls="kepegawaian" aria-selected="false">Data Kepegawaian</button>
                        </li>
                        <li class="mr-2" role="presentation">
                            <button
                                class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300"
                                id="alamat-tab" data-tabs-target="#alamat" type="button" role="tab"
                                aria-controls="alamat" aria-selected="false">Alamat & Kontak</button>
                        </li>
                        <li role="presentation">
                            <button
                                class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300"
                                id="keluarga-tab" data-tabs-target="#keluarga" type="button" role="tab"
                                aria-controls="keluarga" aria-selected="false">Data Keluarga</button>
                        </li>
                    </ul>
                </div>
                ...
                <div id="myTabContent" class="space-y-6">
                    ...
                    <!-- TAB 1: PROFIL -->
                    <div class="p-6 bg-white rounded-base border border-gray-200 shadow-sm dark:bg-gray-800 dark:border-gray-700"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="name" value="{{ old('name', $pegawai->name ?? '') }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-base focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                    required placeholder="Nama lengkap dengan gelar">
                            </div>
                            <div>
                                <label
                            ...
                            <div>
                                ...
                                <input type="number" name="nonik"
                                    value="{{ old('nonik', $pegawai->nonik ?? '') }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-base focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                            </div>
                            <div>
                                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">No.
                                    KK</label>
                                <input type="number" name="nokk" value="{{ old('nokk', $pegawai->nokk ?? '') }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-base focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                            </div>
                            <div>
                                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tempat
                                    Lahir</label>
                                <input type="text" name="kotalahir"
                                    value="{{ old('kotalahir', $pegawai->kotalahir ?? '') }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-base focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                            </div>
                            <div>
                                ...
                                <input type="date" name="tanggallahir"
                                    value="{{ old('tanggallahir', $pegawai->tanggallahir ?? '') }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-base focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                            </div>
                            ...
                            <div class="flex items-center gap-6 mt-2">
                                <div class="flex items-center">
                                    <input id="jk-l" type="radio" value="L" name="jk"
                                        {{ old('jk', $pegawai->jk ?? '') == 'L' ? 'checked' : '' }}
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500">
                                    <label for="jk-l"
                                        class="ms-2 text-sm font-medium text-gray-900">Laki-laki</label>
                                </div>
                                <div class="flex items-center">
                                    <input id="jk-p" type="radio" value="P" name="jk"
                                        {{ old('jk', $pegawai->jk ?? '') == 'P' ? 'checked' : '' }}
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500">
                                    <label for="jk-p"
                ...
                <!-- TAB 2: KEPEGAWAIAN -->
                <div class="hidden p-6 bg-white rounded-base border border-gray-200 shadow-sm dark:bg-gray-800 dark:border-gray-700"
                    id="kepegawaian" role="tabpanel" aria-labelledby="kepegawaian-tab">
                    <h4 class="text-xl font-bold text-gray-900 dark:text-white mb-6">Data Kepegawaian</h4>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jenis
                                PTK</label>
                            <input type="text" name="jenis_ptk"
                                value="{{ old('jenis_ptk', $pegawai->jenis_ptk ?? '') }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-base focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                        ...
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pangkat /
                                Golongan</label>
                        ...
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Sumber
                                Gaji</label>
                            <input type="text" name="sumber_gaji"
                                value="{{ old('sumber_gaji', $pegawai->sumber_gaji ?? '') }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-base focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                        </div>
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Lembaga
                                Pengangkatan</label>
                            <input type="text" name="lembaga_pengangkatan"
                                value="{{ old('lembaga_pengangkatan', $pegawai->lembaga_pengangkatan ?? '') }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-base focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                        </div>
                        ...
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">SK
                                Pengangkatan</label>
                            <input type="text" name="sk_pengangkatan"
                                value="{{ old('sk_pengangkatan', $pegawai->sk_pengangkatan ?? '') }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-base focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                        </div>
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tgl SK
                                Pengangkatan</label>
                            <input type="date" name="tgl_sk" value="{{ old('tgl_sk', $pegawai->tgl_sk ?? '') }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-base focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                        </div>
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">SK CPNS</label>
                            <input type="text" name="sk_cpns"
                                value="{{ old('sk_cpns', $pegawai->sk_cpns ?? '') }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-base focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                        </div>
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tgl
                                CPNS</label>
                            <input type="date" name="tgl_cpns"
                                value="{{ old('tgl_cpns', $pegawai->tgl_cpns ?? '') }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-base focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                        </div>
                    </div>
                </div>
                ...
                <!-- TAB 3: ALAMAT & KONTAK -->
                <div class="hidden p-6 bg-white rounded-base border border-gray-200 shadow-sm dark:bg-gray-800 dark:border-gray-700"
                    id="alamat" role="tabpanel" aria-labelledby="alamat-tab">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <textarea name="alamat" rows="3"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-base focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ old('alamat', $pegawai->alamat ?? '') }}</textarea>
                        </div>
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Dusun</label>
                            <input type="text" name="dusun" value="{{ old('dusun', $pegawai->dusun ?? '') }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-base focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                        </div>
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kelurahan /
                                Desa</label>
                            <input type="text" name="kelurahan"
                                value="{{ old('kelurahan', $pegawai->kelurahan ?? '') }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-base focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                        </div>
                        <div>
                            <label
                            ...
                            <input type="text" name="kecamatan"
                                value="{{ old('kecamatan', $pegawai->kecamatan ?? '') }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-base focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                        </div>
                        <div>
                ...
                <!-- TAB 4: KELUARGA -->
                <div class="hidden p-6 bg-white rounded-base border border-gray-200 shadow-sm dark:bg-gray-800 dark:border-gray-700"
                    id="keluarga" role="tabpanel" aria-labelledby="keluarga-tab">
                    <h4 class="text-xl font-bold text-gray-900 dark:text-white mb-6">Data Pasangan</h4>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Suami /
                                Istri</label>
                        ...
                        <div>
                            ...
                            <input type="text" name="pekerjaan_pasangan"
                                value="{{ old('pekerjaan_pasangan', $pegawai->pekerjaan_pasangan ?? '') }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-base focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                        </div>
                    </div>
                </div>
        ...
        <div
            class="lg:hidden fixed bottom-14 left-0 w-full bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 p-4 shadow-lg z-30 flex gap-2">
            <button type="submit"
                class="flex-1 flex justify-center items-center gap-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-base text-sm px-5 py-2.5">
            ...
            <a href="{{ route('pegawai.index') }}"
                class="flex-1 text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-base text-sm px-5 py-2.5 text-center">Batal</a>
        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function setActiveTab(tabId) {
                ...
                activeTab.classList.add('text-blue-600', 'border-blue-600', 'dark:text-blue-500',
                    'dark:border-blue-500');

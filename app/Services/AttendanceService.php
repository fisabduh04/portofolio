...
class AttendanceService
{
    ...
    public function calculateDailyAttendance($pegawai, $date)
    {
        ...
        // 2. Determine Schedule (Waterfall Priority: Event > Override > Piket/Jadwal > Default Rule with Mandatory logic)
    ...
    public function getDailySchedule($pegawai, $date)
    {
        ...
        // 5. Default Rule (Now using ruleAllocations for current year)
        $tahun = \App\Models\Tahun::where('tanggalmulai', '<=', $date)
        ...
        // 6. CHECK MANDATORY DAYS (From PegawaiWajibHadir)
